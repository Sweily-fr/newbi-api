...
describe('Product Resolver - Query.product', () => {
  ...
  it('should return a product by id', async () => {
    ...
    const result = await resolver(null, { id: 'prod-1', workspaceId }, mockContext);
  ...
  it('should throw FORBIDDEN when workspaceId mismatches', async () => {
    await expect(
      resolver(null, { id: 'prod-1', workspaceId: 'different-ws' }, mockContext)
...
describe('Product Resolver - Query.products', () => {
  ...
  it('should return paginated product list', async () => {
    ...
    const result = await resolver(null, { workspaceId, page: 1, limit: 10 }, mockContext);
  ...
  it('should apply search filter', async () => {
    ...
    await resolver(null, { workspaceId, search: 'SEO', page: 1, limit: 10 }, mockContext);
