...
const purchaseOrderSchema = new mongoose.Schema(
  {
    ...
    number: {
      ...
      validate: {
        ...
        message:
          "Le numéro de bon de commande doit contenir uniquement des lettres, chiffres ou tirets (max 20 caractères)",
      },
    },
    purchaseOrderNumber: {
      type: String,
      ...
      validate: {
        ...
        message:
          "La référence doit contenir uniquement des lettres, chiffres, tirets ou slashs (max 50 caractères)",
      },
    },
    issueDate: {
      type: Date,
...
purchaseOrderSchema.statics.numberExistsForYear = async function (
  number,
  workspaceId,
  year,
) {
