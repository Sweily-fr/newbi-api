...
const STRIPE_API_KEY_REGEX = /^(sk_test_|sk_live_|pk_test_|pk_live_)[a-zA-Z0-9_]{24,}$/;
  ...
  switch (provider) {
    case 'stripe':
      ...
      if (apiKey.startsWith('pk_')) {
        console.warn('Attention: Utilisation d\'une clé publique Stripe. Il est recommandé d\'utiliser une clé secrète pour une intégration complète.');
      }
      break;
