...
// ✅ Phase A.4 — Subscription check on all calendar color label mutations
Object.keys(calendarColorLabelsResolvers.Mutation).forEach((name) => {
  const original = calendarColorLabelsResolvers.Mutation[name];
  calendarColorLabelsResolvers.Mutation[name] = async (
    parent,
    args,
    context,
    info,
