      ...
      async (
        ...
        const template = new InvoiceTemplate({
          ...
          termsAndConditionsLinkTitle:
            invoice.termsAndConditionsLinkTitle || undefined,
          ...
          shipping: invoice.shipping
            ? {
                ...
                shippingVatRate:
                  invoice.shipping.shippingVatRate != null
                    ? invoice.shipping.shippingVatRate
                    : 20,
              }
            : undefined,
        ...
        logger.info(
          `[InvoiceTemplate] Template "${name}" created from invoice ${invoiceId}`,
        );
        return saved;
      },
    ),
...
// ✅ Phase A.2 — Subscription check sur toutes les mutations template facture
const originalInvoiceTemplateMutations = invoiceTemplateResolvers.Mutation;
invoiceTemplateResolvers.Mutation = Object.fromEntries(
  Object.entries(originalInvoiceTemplateMutations).map(([name, fn]) => [
    name,
